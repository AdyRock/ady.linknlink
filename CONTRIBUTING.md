...
* `npm run lint` checks app-owned source files used for regular development work.
* `npm run lint:all` checks the full workspace using `.eslintignore` to skip bundled vendor artifacts.
